...
import io.github.supercube.config.apidoc.customizer.FrameworkSwaggerCustomizer;
...
import static io.github.supercube.config.FrameworkConstants.SPRING_PROFILE_SWAGGER;
...
@AutoConfigureAfter(FrameworkProperties.class)
@EnableSwagger2
...
public class SwaggerAutoConfiguration {
     ...
     */
    public SwaggerAutoConfiguration(FrameworkProperties frameworkProperties) {
        this.properties = frameworkProperties.getSwagger();
    }
    ...
    public Docket swaggerSpringfoxApiDocket(List<FrameworkSwaggerCustomizer> swaggerCustomizers,
     ...
     */
    @Bean
    public FrameworkSwaggerCustomizer frameworkSwaggerCustomizer() {
        return new FrameworkSwaggerCustomizer(properties);
    }
