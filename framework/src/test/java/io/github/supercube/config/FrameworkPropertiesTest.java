...
public class FrameworkPropertiesTest {
    ...
    public void testLoggingUseJsonFormat() {
        FrameworkProperties.Logging obj = properties.getLogging();
        boolean val = FrameworkDefaults.Logging.useJsonFormat;
    ...
    public void testClientAppName() {
        FrameworkProperties.ClientApp obj = properties.getClientApp();
        String val = FrameworkDefaults.ClientApp.name;
