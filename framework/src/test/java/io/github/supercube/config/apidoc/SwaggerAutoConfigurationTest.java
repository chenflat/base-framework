...
import io.github.supercube.config.FrameworkProperties.Swagger;
...
public class SwaggerAutoConfigurationTest {
    ...
    public void setup() {
        ...
        final FrameworkProperties frameworkProperties = new FrameworkProperties();
        properties = frameworkProperties.getSwagger();
        ...
        config = new SwaggerAutoConfiguration(frameworkProperties) {
            @Override
    ...
    public void testSwaggerSpringfoxApiDocket() {
        List<FrameworkSwaggerCustomizer> customizers = Lists.newArrayList(new FrameworkSwaggerCustomizer(properties));
